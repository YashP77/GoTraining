...
const (
	MessageService_SaveMessage_FullMethodName = "/messages.v1.MessageService/SaveMessage"
	MessageService_GetLast10_FullMethodName   = "/messages.v1.MessageService/GetLast10"
)
...
func (c *messageServiceClient) GetLast10(ctx context.Context, in *GetLast10Request, opts ...grpc.CallOption) (*GetLast10Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedMessageServiceServer) GetLast10(context.Context, *GetLast10Request) (*GetLast10Response, error) {
...
func _MessageService_GetLast10_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MessageServiceServer).GetLast10(ctx, req.(*GetLast10Request))
	}
	return interceptor(ctx, in, info, handler)
}
